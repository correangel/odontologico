<form role="form" action="<?php echo base_url('index.php/paciente/update'); ?>" method="post">
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			...
			<input type="hidden" value="<?php echo $paciente[0]->idPacientes ?>" name="idPacientes">
			...
			<div class="row">
				...
				<div class="form-group radio col-xs-4 btn-group"  data-toggle="buttons">
					...
					<label class="btn btn-default <?php if($paciente[0]->sexo == "F"){ echo 'active'; } else { echo ''; }  ?>">
						<input type="radio" name="sexo" id="sexo2" value="F"   <?php if($paciente[0]->sexo == "F"){ echo 'checked'; } else { echo ''; }  ?>>
						Feminino
					</label>
				</div>
